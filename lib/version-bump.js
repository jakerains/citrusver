...
class CitrusVer {
  ...
  async promptForMessage(version, versionType) {
    ...
    return new Promise((resolve, reject) => {
      // Show the beautiful lemon art
      console.log(detailedLemon);
      
      // Show commit message prompt
      console.log(`
            ${colors.brightCyan}========================================${colors.reset}
                 📝 ${colors.bright}COMMIT MESSAGE${colors.reset} for ${colors.brightYellow}v${version}${colors.reset}
            ${colors.brightCyan}========================================${colors.reset}
                    
            ${colors.gray}Press ENTER for version-only commit${colors.reset}
                 ${colors.gray}Press ESC to cancel${colors.reset}
      `);
